...
- **PG log:** `ssh vuzol python3 /root/scripts/agent-log.py --space medicine --agent researcher --status done --model MODEL --tokens IN,OUT --cost USD --duration MS --summary "what was done"`
