...
ssh vuzol python3 /root/scripts/memory-to-qdrant.py --search "ключові слова" --agent test-000916/test-000916
...
```bash
# 1. Створити файл
# Для простору: ~/spaces/test-000916/memory/<name>.md
# Для агента:   ~/spaces/test-000916/memory/agents/test-000916/<name>.md
...
# agent: test-000916  # тільки для agent-типу
# ---
